...
, function(e, t) {
    function n() {
        ...
        if ("IntersectionObserver"in window && "IntersectionObserverEntry"in window && "intersectionRatio"in window.IntersectionObserverEntry.prototype)
            for (var t = new IntersectionObserver(o,{
                root: null,
                rootMargin: "20px",
                threshold: .5
            }), n = 0; n < e.length; n++)
    ...
    function i(e, t) {
        ...
        var i = setInterval(function() {
            ...
            ((o = a) >= t.end && "inc" == r || o <= t.end && "dec" == r) && (clearInterval(i),
            o != t.end && (e.innerHTML = t.decimals <= 0 ? parseInt(t.end) : parseFloat(t.end).toFixed(t.decimals)))
        }, t.delay)
    }
    function a(e) {
    ...
    function u(e) {
        for (var t = e.offsetTop, n = e.offsetLeft, r = e.offsetWidth, o = e.offsetHeight; e.offsetParent; )
